...
export function DottedSurface({ className, ...props }: DottedSurfaceProps) {
	...
	useEffect(() => {
		...
		for (let ix = 0; ix < AMOUNTX; ix++) {
			for (let iy = 0; iy < AMOUNTY; iy++) {
				...
				// Matrix Theme (Neon Green) - Three.js Float32BufferAttribute vertex colors are typically 0.0-1.0
	...
	return (
		<div
			...
			style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', zIndex: -1, ...props.style }}
			{...props}
		/>
	);
}
